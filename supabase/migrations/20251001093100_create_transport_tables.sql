...
-- Table des lignes de bus urbains
...
-- Table des agences de transport interprovincial
...
-- Table des trajets interprovinciaux
...
-- Politiques de sécurité : Lecture publique pour tous
...
-- Politiques pour les administrateurs authentifiés (INSERT, UPDATE, DELETE)
